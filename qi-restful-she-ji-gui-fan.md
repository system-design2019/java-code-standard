...
### 4. 以资源为中心的 URL 设计 <a id="4-&#x4EE5;&#x8D44;&#x6E90;&#x4E3A;&#x4E2D;&#x5FC3;&#x7684;-URL-&#x8BBE;&#x8BA1;"></a>
...
### 5. 使用正确的 Method <a id="5-&#x4F7F;&#x7528;&#x6B63;&#x786E;&#x7684;-Method"></a>
...
#### 不符合 CRUD 的情况 <a id="&#x4E0D;&#x7B26;&#x5408;-CRUD-&#x7684;&#x60C5;&#x51B5;"></a>
...
### 6. Query 让查询更自由 <a id="6-Query-&#x8BA9;&#x67E5;&#x8BE2;&#x66F4;&#x81EA;&#x7531;"></a>
...
### 7. 分页 Pagination <a id="7-&#x5206;&#x9875;-Pagination"></a>

当返回某个资源的列表时，如果要返回的数目特别多，比如 github 的 `/users`，就需要使用分页分批次按照需要来返回特定数量的结果。

分页的实现会用到上面提到的 url query，通过两个参数来控制要返回的资源结果：

* per\_page：每页返回多少资源，如果没提供会使用预设的默认值；这个数量也是有一个最大值，不然用户把它设置成一个非常大的值（比如 `99999999`）也失去了设计的初衷
...
### 9. 错误处理：给出详细的信息 <a id="9-&#x9519;&#x8BEF;&#x5904;&#x7406;&#xFF1A;&#x7ED9;&#x51FA;&#x8BE6;&#x7EC6;&#x7684;&#x4FE1;&#x606F;"></a>
...
### 11. 限流 rate limit <a id="11-&#x9650;&#x6D41;-rate-limit"></a>
...
Github 更进一步，提供了不影响当然 `RateLimit` 的请求查看当前 `RateLimit` 的接口 [**GET /rate\_limit**](https://developer.github.com/v3/rate_limit/)。

### 12. Hypermedia API <a id="12-Hypermedia-API"></a>
